...
NS_LOG_COMPONENT_DEFINE ("Tree - 128 Nodes");
...
int main (int argc, char *argv[])
{
  ...
  // SET VARIABLES
  std::string animFile = "TREE128.xml" ;  // Name of file for animation output
  uint32_t nNodes = 128;  // Declare the number of nodes desired (Overridden by commandline args)
