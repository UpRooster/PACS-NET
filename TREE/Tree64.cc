...
NS_LOG_COMPONENT_DEFINE ("Tree - 64 Nodes");
...
int main (int argc, char *argv[])
{
  ...
  // SET VARIABLES
  std::string animFile = "TREE64.xml" ;  // Name of file for animation output
  uint32_t nNodes = 64;  // Declare the number of nodes desired (Overridden by commandline args)
